  ...
  return (
    <Section id="home" spacing="hero" className="relative overflow-hidden pt-12 sm:pt-16 lg:pt-20">
      <div className="relative">
        <div className="pointer-events-none absolute inset-x-[-8%] inset-y-[-12%] -z-10 overflow-hidden">
        ...
        <div className="grid gap-16 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10">
            ...
            <motion.h1
              variants={fadeInUp}
              className="mt-4 max-w-4xl font-display text-[clamp(3.4rem,12vw,6.4rem)] font-bold tracking-[-0.07em] text-white sm:text-[clamp(4.4rem,9vw,6.8rem)] lg:leading-[0.92]"
            >
          ...
          >
            ...
            <Card className="overflow-hidden p-4 sm:p-5">
              <div className="panel-grid relative overflow-hidden rounded-[1.85rem] border border-white/10 bg-slate-950/75 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                ...
                <div className="hero-badge absolute bottom-6 right-6 z-10 flex h-16 w-16 items-center justify-center rounded-full text-lg font-semibold tracking-[0.08em] text-cyan-50">
                  GK
                </div>
                <img
